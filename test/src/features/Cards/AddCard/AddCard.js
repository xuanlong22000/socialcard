...
function AddCard(props) {
    ...
    async function handleOnSubmit(event) {
        try {
            ...
            if (avatar && name && desc && (fullAvatar.type === 'image/jpeg' || fullAvatar.type === 'image/png') && (fullImage.type === 'image/jpeg' || fullImage.type === 'image/png' || !image)) {
                dispatch(addPosts(newCard))
                dispatch(revertAdd(newCard))
